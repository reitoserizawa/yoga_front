...
function ClassScheduleItem ({yogaClass, yoga_instructor, student, handleDelete, handleChange}) {
    ...
    return (
        <div class= "yoga-schedule"> 
            <div class="yoga_row">
                <h4>{schedule_date}</h4>
                <button type="button" class= 'yoga_change_button' onClick={() => handleDelete(yogaClass)}>Cancel Class</button>
                <button type="button" class= 'yoga_change_button' onClick={() => handleChange(yogaClass)}>Change Class</button>
            </div>
            <div class="yoga_column1">
                <div class="item">
                    <strong>Instructor: </strong>{yoga_instructor.first_name} {yoga_instructor.last_name}
                </div>
                <div class="item">
                    <strong>Class type: </strong>{yoga_type}
                </div>
                <div class="item">
